...
public class FoodItemRepositoryImpl implements FoodItemRepository {
    ...
    public FoodItem save(FoodItem foodItem) {
        log.debug("Saving food item [foodItemName={}, restaurantName={}]", foodItem.getName(), foodItem.getRestaurant().getName());
    ...
    public Optional<FoodItem> findById(UUID foodItemId) {
        log.debug("Finding food item by id [foodItemId={}]", foodItemId);
    ...
    public Optional<FoodItem> findByIdAndRestaurantId(UUID foodItemId, UUID restaurantId) {
        log.debug("Finding food item by id and restaurant id [foodItemId={}, restaurantId={}]", foodItemId, restaurantId);
    ...
    public PageResult<FoodItem> findAllByRestaurantId(UUID restaurantId, PageRequest pageRequest) {
        log.debug("Finding all food items by restaurant id [restaurantId={}, pageNumber={}, pageSize={}]", restaurantId, pageRequest.page(), pageRequest.size());
    ...
    public PageResult<FoodItem> findAllActiveByRestaurantId(UUID restaurantId, PageRequest pageRequest) {
        log.debug("Finding all active food items by restaurant id [restaurantId={}, pageNumber={}, pageSize={}]", restaurantId, pageRequest.page(), pageRequest.size());
        Pageable springPageable = PageMapper.toSpringPageable(pageRequest);
    ...
    public boolean existsInRestaurantById(UUID restaurantId, UUID foodItemId) {
        log.debug("Checking if food item exists in restaurant by id [foodItemId={}, restaurantId={}]", foodItemId, restaurantId);
    ...
    public boolean existsByNameIgnoreCaseAndRestaurantId(String foodName, UUID restaurantId) {
        log.debug("Checking if food item exists by name ignoring case and restaurant id [foodName={}, restaurantId={}]", foodName, restaurantId);
